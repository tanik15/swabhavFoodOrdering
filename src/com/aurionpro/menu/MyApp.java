...
import com.aurionpro.login.CustomerNotFoundException;
import com.aurionpro.login.InvalidContactNumber;
import com.aurionpro.login.InvalidPassword;
import com.aurionpro.login.User;
import com.aurionpro.login.UserService;
import com.aurionpro.login.UsernameNotAvailable;
import com.aurionpro.order.Order;
import com.aurionpro.order.OrderItem;
import com.aurionpro.payments.NoPaymentOptionFoundException;
import com.aurionpro.payments.PaymentService;
	...
	private static User authenticateUser(Scanner scanner) throws ClassNotFoundException, IOException {
		...
		if (choice == 1) {
			...
			try {
				...
				return currentUser;
				// TODO Auto-generated catch block
			} catch (UsernameNotAvailable | InvalidContactNumber | InvalidPassword exception) {
				System.out.println(exception.getMessage());
